    ...
    <div class="contenedor">
        ...
        <div class="flex">
            <div class="card" style="width: 35rem;">
                <img src="{{ asset('imagenes/colaboradores/diseñadoraEjemplo.jpg') }}" class="card-img-top"
                    alt="...">
                <div class="card-body">
                    ...
                    <div class="btnContenedor">
                        <a href="#" class="botonMini btnRed">Contacto</a>
                        <a href="/colaboradores/1" class="botonMini btnRed">Nuestros Trabajos</a>
                    </div>
                </div>
            </div>
            <div class="card" style="width: 35rem;">
                <img src="{{ asset('imagenes/colaboradores/arquitectoEjemplo.jpg') }}" class="card-img-top"
                    alt="...">
                <div class="card-body">
            ...
            <div class="card" style="width: 35rem;">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-Subtitle">Ingeniera de Software</h5>
                    <p class="card-text">Ana López es una ingeniera de software con más de 12 años de experiencia en
                        desarrollo de aplicaciones y sistemas empresariales. Destacada por su habilidad técnica y
                        enfoque
                        orientado a soluciones. Ana forma parte de nuestro equipo desde hace más de 6 años,
                        contribuyendo
                        con su talento y experiencia en la creación de software innovador y eficiente.</p>
                    <div class="btnContenedor">
                        <a href="#" class="botonMini btnRed">Contacto</a>
                        <a href="/colaboradores/1" class="botonMini btnRed">Nuestros Trabajos</a>
                    </div>
            ...
            <div class="card" style="width: 35rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">David Fernández es un consultor de marketing con más de 8 años de experiencia
                        en
                        estrategias digitales y desarrollo de marca. Conocido por su pensamiento estratégico y enfoque
                        en
