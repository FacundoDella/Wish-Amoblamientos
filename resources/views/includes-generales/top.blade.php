<div class="contenedor-top-bg">
    <div class="contenedor-top">
        <div class="contenedor-info">
            <div class="info">
                <svg class="info-svg" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                ...
                <span class="info-span">(291) 4296878</span>
            </div>
            <div class="info">
                <svg class="info-svg" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <span class="info-span">Lunes a Viernes de 8 a 19hs./Sabados: 10 a 13hs.</span>
            </div>
        </div>
