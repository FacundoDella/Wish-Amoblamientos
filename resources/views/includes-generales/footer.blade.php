<div class="footerContenedor">
    <div class="footer">
        <div class="footerLogo">
            <img src="{{ asset('imagenes/logoSinFondo.jpg') }}" alt="">
        </div>
        <div class="footerContacto">
            <div class="footerItems">
                <svg class="svgFooter" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor"
            ...
            <div class="footerItems">
                ...
                <div>Felix Fría 1430</div>
            </div>
            <div class="footerRedes">
                <a class="icono-footer" href=""><svg class="enlace-svgFooter" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="derechos">
        <p>© 2024 Wish Amoblamientos. Todos los derechos reservados.</p>
    </div>
</div>
